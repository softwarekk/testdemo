...
public class ToastUtils {
	...
	public static void showToast(int resID,Activity instance) {
		showToast(instance, Toast.LENGTH_SHORT,
				resID);
	}

	public static void showToast(String text,Activity instance) {
		showToast(instance, Toast.LENGTH_SHORT, text);
	}
	...
	public static void showLongToast(int resID,Activity instance) {
		showToast(instance, Toast.LENGTH_LONG, resID);
	}
	...
	public static void showLongToast(String text,Activity instance) {
		showToast(instance, Toast.LENGTH_LONG, text);
	}
