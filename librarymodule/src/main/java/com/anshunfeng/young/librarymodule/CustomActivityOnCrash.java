...
package com.anshunfeng.young.librarymodule;
...
import com.anshunfeng.young.librarymodule.activity.DefaultErrorActivity;
...
public final class CustomActivityOnCrash {
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CustomActivityOnCrash.EXTRA_IMAGE_DRAWABLE_ID, R.drawable.sample_footer_loading);
    }
